...
import { asyncHandler, validateBody, validateParam } from "../middleware/validate.js";
...
beaconRouter.get("/:id", validateParam("id", beaconIdSchema, "invalid beacon id"), asyncHandler(getBeaconById));
beaconRouter.post(
  "/:id/led",
